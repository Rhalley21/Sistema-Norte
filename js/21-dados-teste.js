...
async function gerarDadosTeste(){
  ...
  cargosParaCriar.forEach(src=>{
    ...
    cargo.versoes.push({
      ...
      area: cargo.desenho.area, nivelHierarquico: cargo.desenho.nivelHierarquico, regimeTrabalho: cargo.desenho.regimeTrabalho,
      subordinacao: cargo.desenho.subordinacao, subordinadosDiretos: cargo.desenho.subordinadosDiretos, localTrabalho: cargo.desenho.localTrabalho,
      missao: cargo.desenho.missao, responsabilidades:[...cargo.desenho.responsabilidades],
      culturaPostura: cargo.desenho.culturaPostura,
      formacaoAcademica: cargo.desenho.formacaoAcademica, experienciaProfissional: cargo.desenho.experienciaProfissional,
      conhecimentosTecnicos: cargo.desenho.conhecimentosTecnicos, idiomas: cargo.desenho.idiomas,
      competenciasComportamentais:[...cargo.desenho.competenciasComportamentais], ferramentasSistemas:[...cargo.desenho.ferramentasSistemas],
      kpis:[...cargo.desenho.kpis], condicoesTrabalho: cargo.desenho.condicoesTrabalho, perspectivasCarreira:[...cargo.desenho.perspectivasCarreira],
